    ...
    <div className="container">
      ...
      <section id="education-intro">
        <div id="text-section-1">
          ...
          <p>PLEASE NOTE: If you were born in the Western world then this information, especially in the Advanced Section, will most likely be VERY different from what has been presented to you as “medicine” previously, and we will get into the reason why that is.</p>
        </div>
