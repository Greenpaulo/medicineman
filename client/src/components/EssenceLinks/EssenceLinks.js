                ...
                <ul>
                  {essences.map((essence, index) => {
                    if (index > 0 && index <= columnLength) {
                      return <li key={essence.name}><Link to={`company/${essence.companySlug}/${essence.groupSlug}/${essence.nameSlug}`}>{essence.name}</Link></li>
                    }
        ...
        <div id="image-grid">
          {essences.map((essence) => (
              <div key={uuid()} className="essence-link-container">
                <Link to={`/company/${essence.companySlug}/${essence.groupSlug}/${essence.nameSlug}`} className="essence-link">
