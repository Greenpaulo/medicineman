  ...
  return (
    <div className="container">
      ...
      <section id="advanced-education" className="my-2">
        ...
        <div id="advanced-section-2" className="bg-secondary py-2 px-2 br-10">
          <h3>GOING DEEPER</h3>
        ...
        <div id="advanced-section-3" className="py-2">
          <h3>WHO ARE WE AND WHERE ARE WE?</h3>

          <p>We are all that exists. We are infinite consciousness having an experience as human. Everything is energy, everything in the universe is connected, we are all one consciousness. Right now, we are all participating in the “Earth Experiment”, which was an experiment to experience the transformation of consciousness/frequency inside a physical form. From a 3rd dimensional frequency, to a 5th dimensional frequency.</p>
        ...
        <div id="advanced-section-5" className="bg-primary py-3 px-2 br-10">
        ...
        <div id="advanced-section-2" className="bg-secondary py-2 px-2 br-10">
          ...
          <p>The medicine spirits teach us about the true nature of reality and in doing so they dissolve any misconceptions which leads to dissolution of negative thought patterns and beliefs, straightening out energy.</p>
          ...
          <p>When you understand the truth of life then you can start to see that all negative thoughts were the consequence of erroneous beliefs that you acquired during your lifetime. Let us go deeper into some of the most common negative thoughts and we will see how they are the result of a misunderstanding or a constricted perception of the nature of reality.</p>
          ...
          <div id="emotions">
            ...
            <p>As we have already mentioned, comes from the misunderstanding that there are events that can happen to us that are not perfect. The truth is that everything that happens to us is meant to be and IS perfect.</p>
        ...
        <div id="advanced-section-4" className="bg-primary py-2 px-2 br-10">
        ...
        <div id="advanced-section-6" className="bg-tertiary py-2 px-2 br-10">
