    ...
    <div className="container">
      ...
      <section id="education-intro">
        <div id="text-section-1">
          <h3>WHAT IS TRADITIONAL MEDICINE?</h3>
          ...
          <h3>MOVE THIS STUFF TO ABOUT PAGE??????????????????</h3>

          <p>From the age of 20 I was extremely interested in plant medicine and shamanism. My journey into medicine began in the Amazonian Rainforest in Peru in 2004. I spent 3 months in Peru experiencing medicine and part of this was the beginning of a traditional apprenticeship into Amazonian plant medicine. This was an life transforming experience working with Ayahuasca and the plant spirits at a relatively early age, and I fully intended to continue my apprenticeship in Peru to completion. However, that was not to be my path!</p>

          <p>On return to the UK, I spent some time trying to bring what I had learnt into the Western world. I realized that if I wanted to practice plant medicine in the UK, I needed to have some kind of qualification, so I undertook a degree in Herbal Medicine and came out with a first class honours degree – BSc Herbal Medicine in 2011.</p>

          <p>During my clinical practice as a student Herbalist I was introduced to the use of flower essences. I began to focus more and more on the spiritual side of plant healing. I wrote my final year dissertation on “Vibrational Medicine in Herbal Clinical Practice”. Vibrational Medicine is a blanket term which includes energy medicines, such as essences, spiritual healing etc.</p> 

          <p>Over the years my herbal practice moved away from herbal preparations of tinctures and dried herbs and towards a focus on essences. I still use tinctures and dried herbs but flower essences became my main plant preparation of choice. I was always searching for the best alternative I could find in the western world for the experience I had with the plant medicines in Peru, and in my opinion essences are the form of plant medicine that mirrors that experience.</p>
          ...
          <p>However during the eighteenth and nineteenth century a change in the medical paradigm to a more mechanistic view of the human body, backed by such thinkers as Isaac Newton and Charles Darwin, led to the fading away of the traditional knowledge of flower essences and other preparations.  In the western world, flower essences stayed in relative obscurity for a while until the 1930’s when a British physician, Dr Edward Bach, brought them back into use. According to Weeks (1973), Dr Bach worked as a bacteriologist at the Royal London Homeopathic Hospital, and it was there that he soon became interested more in the patients themselves than their diseases. Talking to patients at their bedside he realised that the real cause of their illnesses was emotional. The body was a mirror reflecting the thoughts in the mind. Bach came to the conclusion that it was the sufferer themselves, the person, who needed the treatment.</p>

          <p>Following his intuition, Dr Bach left London in 1930 to explore the English countryside in a hope to find plant medicines that could treat his patient’s emotional problems (Weeks, 1973). This led to the discovery of the Bach Flower Remedies which are probably the most famous flower essences in the world.</p>

          <h3>HOW DO THEY WORK?</h3>

          <p>Flowers are the most evolved part of the plant kingdom and carry positive, life affirming patterns of conscious energy. A flower essence is a vibrational medicine that contains the high-frequency subtle energies of the plant it was made from and these energies are said to be able to act on the subtle-energy bodies of the human being. By acting on the human energy body, it is believed that the vibrational energies of the flowers can assist in realigning the emotional patterns of dysfunction. Bach’s understanding was that by correcting these emotional factors, the patient would then be assisted in increasing their physical and mental vitality and therefore be aided in the resolution of their physical disease. At a deeper level flower essences are an intelligent healing energy and a catalyst for evolution in human consciousness and that they help to identify mental and emotional qualities that need to be awakened or strengthened to stimulate spiritual growth.</p>

          <p>However as the physiological effects of flower essences on the energy system are difficult to measure with our current, popular, medical technology then the sceptics would say that there is little hard evidence for using flower essences to treat physical disease.  Methods to measure vibrational medicine do exist however, in the form of radionics, Kirlian photography and electroacupunture but are not currently accepted in our medical paradigm (Gerber, 2001).</p>

          <p>Since the death of Dr Bach in 1936 many flower essence producers around the world have continued his work and contributed to the re-introduction of flower essences into modern medicine.  One of the first to do this was the Flower Essence Society (FES) established by Richard Katz in 1979.  The FES are based in California and are a group of flower essence practitioners who introduced a new group of essences made from flowers indigenous to the USA (Gerber, 2001).</p>
          ...
          <p>Everything in the universe is energy. Shamans have known this for a long time and now even science has caught up to this understanding in areas such as quantum physics. Energy and spirit are synonyms.</p>
          ...
          (ADD PETER TADD ARTICLE)</p>

          <h3>THE CONTINUATION OF AN APPRENTICESHIP</h3>

          <p>As I look back on the last 10 years of working with essences, I realise that my apprenticeship with the medicine spirits never ended. The method of learning stayed the same, the only thing that changed was the setting and the plant preparation.</p>

          <p>Nowadays, I keep a journal of all insights that I have whilst taking an essence. The process of writing, aids in the direct “download” of medicine, in the form of truth and insight from the spirits.</p>
