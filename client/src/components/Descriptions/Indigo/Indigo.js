...
const Indigo = () => {
  return (
    <div>
      ...
      <p>Of course there is a child in all of us and the Indigo Essences can be used by anyone who recognises that their own child needs some healing and support.</p>
