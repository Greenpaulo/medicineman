...
const Pacific = () => {
  return (
    <div>
      <p>Pacific Essences® formulates pure Flower, Sea and Gem & Crystal Essences as non-invasive, gentle and effective tools for healing. As the leading practitioners and pioneers of Energy Medicine®, we have over 30 years of experience producing, teaching and testing essences on individuals and in case studies.</p>

      <h3>What is an Essence?</h3>
      <p>Essences are a safe, easy to use form of Energy Medicine®. The remedies support rebalancing on the wholistic level, to achieve physical, emotional, mental and spiritual homeostasis.</p>

      <p>We call it energy medicine because in fact it is through the essences’ relationship and interaction with the energy systems (chakras and meridians) in the human being that healing occurs.</p>
      ...
      <p>Typically taken orally, essences can be used directly from the stock bottle or prepared into a dosage bottle. The general rule for making a dosage bottle is to fill a clean, glass dropper bottle with a dilution of 25% alcohol/brandy (a preservative) and 75% water. Choose the purest water available. Add two or more drops from the stock essence bottle and shake gently. Label. Ready for use. Drops from the dosage bottle can be taken directly or in a glass of water. Alternately, replace the dropper bottle with a mister bottle for an external-skin spray.</p>

      <p>The daily dosage is individual, generally, 4 drops, 2-4 x a day or 11 drops morning and evening. Trust your intuition. Essences are completely safe and can be used as a single remedy or in combinations.</p>

      <p>Essences can also be used in the bath.</p>
